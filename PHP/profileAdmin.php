...
<div class="mainContainer">
	...
	<div class="row">
        ...
        <!-- <div class="col-sm-2 col-md-2" style="border-style: ridge; padding: 10px;">

        <button class="btn btn-warning" style="width: 100%; margin: 5px;" onclick="showUsers()">Utilizatori</button>
        <button class="btn btn-warning" style="width: 100%; margin: 5px;" onclick="showProviders()">Furnizori</button>
        <button class="btn btn-warning" style="width: 100%; margin: 5px;" onclick="showClients()">Clienti pers. fizice</button>
        <button class="btn btn-warning" style="width: 100%; margin: 5px;" onclick="showCompanies()">Clienti pers. juridice</button>
        <button class="btn btn-warning" style="width: 100%; margin: 5px;" onclick="showProducts()">Produse</button>
        <button class="btn btn-warning" style="width: 100%; margin: 5px;" onclick="showSasiuOption()">Sasiuri</button>
        <button class="btn btn-warning" style="width: 100%; margin: 5px;" onclick="showInvoiceOption()">Facturi emise</button>
        <button class="btn btn-warning" style="width: 100%; margin: 5px;" onclick="showReceivedInvoices()">Facturi intrate</button>
        <button class="btn btn-warning" style="width: 100%; margin: 5px;" onclick="showReturnOption()">Retururi</button>
            <button class="btn btn-warning" style="width: 100%; margin: 5px;" onclick="showReferenceCodes()">Coduri referinta</button>
        </div> -->
    ...
    <div class="sidenav">
        <div class="btn btn-warning" style="border-style: ridge; height: 50px; float: top; vertical-align: center; margin-bottom: 5px;">
            <a onclick="showUsers()" title="Utilizatori">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="35" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
    ...
    <div class="modal fade" id="addProductPopup" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h2 class="modal-title" id="exampleModalLongTitle">Selectare produs</h2>       
                </div>
                <div class="modal-body">
                <form>
                    <div class="form-group">
                        <label for="selectProductForOwnInvoice">Nume produs</label>
                        <select class="form-control" id="selectProductForOwnInvoice" name="selectProductForOwnInvoice">
                            <option value='-1'>Alegere produs</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="ownInvoiceProductPrice">Pret</label>
                        <input type="number" class="form-control" id="ownInvoiceProductPrice" 
                        name="ownInvoiceProductPrice" placeholder="Pret produs" disabled/>
                    </div>
                    <div class="form-group">
                        <label for="ownInvoiceProductQuantity">Cantitate</label>
                        <input type="number" class="form-control" id="ownInvoiceProductQuantity" name="ownInvoiceProductQuantity" placeholder="Cantitate"/>
                    </div>
                    <div class="form-group">
                        <label for="ownInvoiceProductVAT">TVA</label>
                        <select class="form-control" id="ownInvoiceProductVAT" name="ownInvoiceProductVAT">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="addProductToInvoice()">Selectare</button>
                </div>
            </div>
        </div>
    </div>
